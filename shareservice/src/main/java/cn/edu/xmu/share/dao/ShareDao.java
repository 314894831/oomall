...
public class ShareDao {
     ...
     */
    public PageInfo<SharePo> getShares(Long goodsSpuId, String beginTime, String endTime, Long userId) {
        ...
        if(goodsSpuId!=null)
        criteria.andGoodsSpuIdEqualTo(goodsSpuId);
     ...
     * @return List<SharePo> 分享列表
     */
    public PageInfo<SharePo> adminGetShares(Long goodsSpuId, Long id) {
        SharePoExample example = new SharePoExample();
        SharePoExample.Criteria criteria = example.createCriteria();
        //TODO 根据店铺id查，缺少接口
        if(goodsSpuId!=null)
     ...
     */
    public PageInfo<BeSharePo> getBeShared(Long goodsSpuId, String beginTime, String endTime, Long userId) {
     ...
     * @return List<BeSharePo> 分享列表
     */
    public PageInfo<BeSharePo> adminGetBeShared(Long id,Long goodsSpuId, String beginTime, String endTime) {
        BeSharePoExample example = new BeSharePoExample();
        BeSharePoExample.Criteria criteria = example.createCriteria();
        //TODO 根据店铺Id查 需要接口
        if(goodsSpuId!=null)
    ...
    public ReturnObject<VoObject> createShareActivity(ShareActivityVo vo, Long shopId, Long spuId) {
        ...
        shareActivityPo.setGoodsSpuId(spuId);
     ...
     * @return List<SharePo> 分享列表
     */
    public PageInfo<ShareActivityPo> getShareActivities(Long goodsSpuId, Long shopId) {
