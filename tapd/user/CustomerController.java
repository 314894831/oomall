...
public class CustomerController {
    ...
    public Object getCustomerSelf(@LoginUser Long customerId) {
        ...
        if(customer.getData()==null){
            ...
            customer=new ReturnObject<>(ResponseCode.INTERNAL_SERVER_ERR);
        }
    ...
    public Object changeCustomerself(@LoginUser Long id, @Validated @RequestBody CustomerVo vo, BindingResult bindingResult) {
        ...
        if (returnObject != null) {
            logger.info("incorrect data received while modifyCustomerInfo id = " + id);
            return returnObject;
        }
    ...
    public Object forbidUser(@LoginUser Long adminId,@PathVariable Long id) {
        if (logger.isDebugEnabled()) {
    ...
    public Object releaseUser(@LoginUser Long adminId,@PathVariable Long id) {
        if (logger.isDebugEnabled()) {
