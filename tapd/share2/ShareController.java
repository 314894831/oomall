...
public class ShareController {
    ...
    public Object adminGetShares(
        ...
        if(page <= 0 || pagesize <= 0) {
            ...
            ReturnObject<PageInfo<VoObject>> returnObject = shareService.adminGetShares(page,pagesize,goodsSkuId,id);
            logger.debug("getShareById: getShares = " + returnObject);
            object = Common.getPageRetObject(returnObject);
        }
        return object;
    ...
    public Object getBeShared(
        ...
        if(page <= 0 || pagesize <= 0) {
            ...
            ReturnObject<PageInfo<VoObject>> returnObject = shareService.getBeShared(page,pagesize,goodsSkuId,beginTime,endTime,userId);
    ...
    public Object adminGetBeShared(
        ...
        if(page <= 0 || pagesize <= 0) {
            ...
            ReturnObject<PageInfo<VoObject>> returnObject = shareService.adminGetBeShared(id,page,pagesize,goodsSkuId,beginTime,endTime);
    ...
    public Object createShareActivity(@Validated @RequestBody ShareActivityVo vo, BindingResult bindingResult,
        ...
        ReturnObject<VoObject> returnObject = shareService.createShareActivity(vo,shopId,skuId);
        if (returnObject.getCode() == ResponseCode.OK) {
            return Common.getRetObject(returnObject);
        } else {
            return Common.decorateReturnObject(returnObject);
    ...
    public Object getShareActivities(
        ...
        if(page <= 0 || pagesize <= 0) {
            ...
            ReturnObject<PageInfo<VoObject>> returnObject = shareService.getShareActivities(page,pagesize,goodsSkuId,shopId);
            logger.debug("getShareById: getShares = " + returnObject);
            object = Common.getPageRetObject(returnObject);
        }
        return object;
