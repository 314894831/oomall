...
import cn.edu.xmu.advertise.model.vo.AdvertisementVo;
import cn.edu.xmu.advertise.model.vo.StateVo;
import cn.edu.xmu.advertise.service.AdvertisementService;
...
public class AdvertisementController
{
    ...
    public Object findAllAdByTimeId(
        ...
        if(page <= 0 || pagesize <= 0) {
            ...
            ReturnObject<PageInfo<VoObject>> returnObject = advertisementService.findAllAdByTimeId(timeId, page, pagesize);
