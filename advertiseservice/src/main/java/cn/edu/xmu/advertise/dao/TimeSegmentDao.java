package cn.edu.xmu.advertise.dao;

import cn.edu.xmu.advertise.mapper.TimeSegmentPoMapper;
...
{
    private static final Logger logger = LoggerFactory.getLogger(cn.edu.xmu.advertise.dao.TimeSegmentDao.class);
