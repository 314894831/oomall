...
import cn.edu.xmu.advertise.mapper.AdvertisementPoMapper;
import cn.edu.xmu.advertise.model.bo.Advertisement;
import cn.edu.xmu.advertise.model.po.AdvertisementPo;
import cn.edu.xmu.advertise.model.po.AdvertisementPoExample;
...
public class AdvertisementDao
{
     ...
     * @author ChengYang Li
     */
    public PageInfo<AdvertisementPo> findAllAdByTimeId(Long timeId, Integer page, Integer pagesize)
    {
        AdvertisementPoExample example = new AdvertisementPoExample();
        AdvertisementPoExample.Criteria criteria = example.createCriteria();
        criteria.andSegIdEqualTo(timeId);
