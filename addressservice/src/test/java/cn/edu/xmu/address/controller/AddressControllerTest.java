...
class AddressControllerTest
{
    ...
    public void ClientTest() throws Exception
    {
        ...
        byte[] responseString = webClient.post().uri("/addresses")
        ...
        String expectedResponse = "{\"errno\":0,\"data\":{\"customerId\":1,\"regionId\":3,\"detail\":\"这是一个详细地址描述\",\"consignee\":\"张三\",\"mobile\":\"1360979565\",\"beDefault\":0,\"gmtModified\":null},\"errmsg\":\"成功\"}";
